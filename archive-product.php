    ...
    <section id="primary" class="content-area ppt-content-area">
        <main id="main" class="site-main" role="main">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="ppt-sidebar ppt-sidebar-shop">
                    ...
                    <div class="col-md-9">
                        <div class="ppt-products">
                            ...
                            if ( $products_query->have_posts() ):
                                ...
                                if ( ! ( $products_query->post_count % 3 == 0 ) ) :
                                    echo '</div><!-- .row -->';
                                endif;
                                ?>
                                <div class="ppt-pagination">
                                    <?php echo paginate_links( [
                                        'prev_text' => '<i class="ppt-icon ppt-chevron-left"></i>',
                                        'next_text' => '<i class="ppt-icon ppt-chevron-right"></i>'
                                    ] ); ?>
                                </div>
                            <?php
