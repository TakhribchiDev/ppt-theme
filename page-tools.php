    ...
    <section id="primary" class="content-area ppt-content-area">
        <main id="main" class="site-main" role="main">
            <div class="container">
                ...
                <div id="toolsPageSlider" class="ppt-toolspage-slider ppt-slider carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <?php for ( $j = 0; $j < sizeof( $slides ); $j++ ) : ?>
                            <li data-target="#toolsPageSlider" data-slide-to="<?php echo $j ?>" class="<?php echo ( $j == 0 ? 'active' : '' ); ?>"></li>
                        <?php endfor; ?>
                    </ol>
                    ...
                    <a href="#toolsPageSlider" class="carousel-control-prev" role="button" data-slide="prev">
                        <i class="ppt-icon ppt-chevron-left-thin"></i>
                        <span class="sr-only">قبلی</span>
                    </a>

                    <a href="#toolsPageSlider" class="carousel-control-next" role="button" data-slide="next">
                ...
                <div class="ppt-products">
                    ...
                    ?>
                    <h2><?php _e( 'لیست ابزارها', 'ppttheme' ) ?></h2>
                ...
                <div id="pricingSlider" class="ppt-pricing-slider ppt-slider carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <?php for ( $j = 0; $j < sizeof( $slides ); $j++ ) : ?>
                            <li data-target="#pricingSlider" data-slide-to="<?php echo $j ?>" class="<?php echo ( $j == 0 ? 'active' : '' ); ?>"></li>
                        <?php endfor; ?>
                    </ol>
                    <div class="carousel-inner">
                    ...
                    <a href="#pricingSlider" class="carousel-control-prev" role="button" data-slide="prev">
                        <i class="ppt-icon ppt-chevron-left-thin"></i>
                        <span class="sr-only">قبلی</span>
                    </a>

                    <a href="#pricingSlider" class="carousel-control-next" role="button" data-slide="next">
                        <i class="ppt-icon ppt-chevron-right-thin"></i>
                        <span class="sr-only">بعدی</span>
                    </a>
